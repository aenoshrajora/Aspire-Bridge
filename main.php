            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <h1 class="white-text" style="font-size: 40px;margin-top: 20px;
							margin-bottom:50px;">Aspire Bridge</h1>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="section-header text-center">
                ...
                <h2 style="margin-top: 100px; font-size: 45px;">Welcome to AspireBridge</h2>
                ...
                <p class="lead"><b style="color: rgb(56, 48, 48);">AspireBridge</b> is one stop destination <br>in
                    helping you understand yourself, the best career for you <br> and providing all the resources in the
                    process.</p>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <?php else: ?>
                <h2 class="white-text" style="font-size: 30px; width:700px ;">Hi,
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="section-header">
                    <h2 style="font-size: 35px;">About AspireBridge</h2>
                    <p class="lead" style="font-size: 18px; margin-top: 50px;">Education seekers get a
                        personalised experience on our site, based on educational background and career interest,
                        ...
                        updates etc as well as by interacting with other AspireBridge users, experts, current students
                        in colleges and alumni groups. We have introduced several student oriented products and tools
                        like Career Prediction, Knowledge Network, Daily Bytes, Blogs, Community discussion forum, and
                        various Courses.</p>
