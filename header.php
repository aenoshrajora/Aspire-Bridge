        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand">
                    <a class="logo" href="main.php">AspireBridge</a>
                </div>
                <!-- /Logo -->
                ...
                <ul class="main-menu nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="http://127.0.0.1/AspireBridge/login.php">Career Prediction</a>
                            <a href="http://127.0.0.1/AspireBridge/courses.php">Courses</a>
                            <a href="http://127.0.0.1/AspireBridge/blog.php">Knowledge Network</a>
